...
let s:colors = {
      \ "red": get(s:overrides, "red", { "gui": "#FF5757", "cterm": "204", "cterm16": "1" }),
      ...
      \ "blue": get(s:overrides, "blue", { "gui": "#8BBDD6", "cterm": "39", "cterm16": "4" }),
      ...
      \ "foreground": get(s:overrides, "foreground", { "gui": "#FFF2DE", "cterm": "145", "cterm16": "NONE" }),
